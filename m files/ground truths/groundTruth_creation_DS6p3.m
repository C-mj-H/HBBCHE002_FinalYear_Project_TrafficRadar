...
Target_locations_DS6_p3 = zeros(NumOfPulses, NumOfRangeBins);
...
%only finds ground truths in final third of the dataset
for z = 1:numIterations
    if z <numIterations
    RangeProfiles = RangeProfiles_AfterEqNotch(1+stepSize*(z-1):stepSize*z,201:300);
    ...
    Target_locations_DS6_p3(1+stepSize*(z-1):stepSize*z,201:300) = finalTargetPnts;

elseif z == numIterations
    RangeProfiles = RangeProfiles_AfterEqNotch(1+stepSize*(z-1):end,201:300);
    [NumOfPulses,NumOfRangeBins]=size(RangeProfiles);
    
    finalTargetPnts = detectionFinder(RangeProfiles,NumOfPulses,NumOfRangeBins, MaxRangeLine);
    Target_locations_DS6_p3(1+stepSize*(z-1):end,201:300) = finalTargetPnts; 
    end
 end

% Manual removal of noise data points registered as targets 
Target_locations_DS6_p3(1663:2149, 203:219) = 0;
Target_locations_DS6_p3(2600:2820, 215:230) = 0;
Target_locations_DS6_p3(5024, 229) = 0;
Target_locations_DS6_p3(6000:6145, 249:264) = 0;
Target_locations_DS6_p3(311:2210, 250:end) = 0;
Target_locations_DS6_p3(300:4035, 265:end) = 0;
Target_locations_DS6_p3(4680:end, 278:end) = 0;
Target_locations_DS6_p3(579:1562, 200:219) = 0;
Target_locations_DS6_p3(373, 211) = 0;
Target_locations_DS6_p3(5182:5570, 274:275) = 0;
Target_locations_DS6_p3(4943:5232, 208:209) = 0;
Target_locations_DS6_p3(2677, 256) = 0;
Target_locations_DS6_p3(5642, 213) = 0;

% % Save the dataset to a .mat file
save('Target_locations_DS6_p3.mat', 'Target_locations_DS6_p3');
...
[pulseCoord, rangeCoord] = find(Target_locations_DS6_p3 == 1);
